<nav class="navbar" style="background: #23223a; padding: 0; box-shadow: 0 2px 8px rgba(0,0,0,0.04);">
    <div class="navbar-content" style="display: flex; align-items: center; justify-content: space-between; max-width: 1200px; margin: 0 auto; height: 64px;">
        ...
        <div style="display: flex; align-items: center; gap: 16px;">
            <a href="https://merchant.qris.interactive.co.id/v2/m/kontenr.php?idir=pages/summary.php" target="_blank" class="navbar-midtrans-btn" title="Go to Midtrans Dashboard" style="padding: 10px 24px; background: linear-gradient(90deg,#2d9cdb,#1b6ca8); color: #fff; border-radius: 6px; text-decoration: none; font-weight: bold; font-size: 1.1rem; box-shadow: 0 2px 8px rgba(45,156,219,0.12); transition: background 0.2s; border: none; outline: none;">
                QRIS Dashboard
            </a>
